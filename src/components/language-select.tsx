...
const LanguageSelect = () => {
  ...
  return (
    <div className='relative'>
      <motion.button
        ref={buttonRef}
        className='bg-foreground/5 hover:bg-foreground/10 flex rounded-xl px-4 py-2 backdrop-blur-xl duration-100'
      ...
      <AnimatePresence initial={false}>
        {isDropdownOpen && (
          <motion.div
            ...
            className={clsx(
              'absolute top-16 z-10 flex w-max flex-col justify-start rounded-lg bg-[#FFFFFF20] shadow-lg backdrop-blur-xl',
