...
const Photo = () => {
  return (
    <div className='border-foreground shadow-elevated absolute top-1/2 left-1/2 z-1 flex h-auto w-40 -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-3xl duration-200 ease-in-out lg:w-60 xl:w-70'>
