...
const Hero = () => {
  return (
    ...
    >
      ...
      <div
        className='hero-noise pointer-events-none absolute top-0 left-0 z-[-1] h-[calc(100svh-var(--parallaxMarqueeMobile-height))] w-full bg-[url("/grain.png")] bg-repeat opacity-100 mix-blend-overlay lg:h-[calc(100svh-100px)]'
        aria-hidden='true'
      />
      {/* <Test /> */}
      {/* <ParallaxMarquee /> */}
