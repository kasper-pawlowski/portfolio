    ...
    <>
      ...
      >
        <div className={`${styles.gridGradient} relative`}>
          ...
          <div
            className={`${styles.div29} ${styles.blank} rounded-br-xl`}
          ></div>
          <div className={`${styles.div30} ${styles.blank} rounded-b-xl`}></div>
          <div
            className={`${styles.div31} ${styles.blank} rounded-bl-xl`}
          ></div>
        ...
        <div className={styles.gridContainer}>
          ...
          <div
            className={`${styles.div13} ${styles.blank} rounded-br-xl`}
          ></div>
          <div
          ...
          <div
            className={`${styles.div19} ${styles.blank} rounded-tl-xl`}
          ></div>
          <div className={`${styles.div20} ${styles.blank} rounded-b-xl`}></div>
          <div
            className={`${styles.div21} ${styles.blank} rounded-bl-xl`}
          ></div>
          ...
          <div
            className={`${styles.div27} ${styles.blank} rounded-tl-xl`}
          ></div>
        </div>
        <div
